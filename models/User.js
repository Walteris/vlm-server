...
var User = {
    ...
    {
      return db.query("select distinct U.T0014_ID as UserID, U.T0014_LastName as User_SurName, U.T0014_FirstName as User_FirstName, " +
      "U.T0018_Primary_Language_Id as Primary_Language, U.T0018_Secondary_Language_Id as Secondary_Language, " +
      "Com.T0037_Desc as Comm_Desc, UE.T0028_Email as User_Email " +
      "from t0014_users U " +
      "left join t0049_surveys  S on S.T0014_ID = U.T0014_ID " +
      "left join j0030_49_24_surveycompanyrelationship SCR on SCR.T0049_ID = S.T0049_ID " +
      "left join t0024_companyorglevel C on C.T0024_ID = SCR.T0024_ID  " +
      "left join t0074_regioncatalog RC on RC.T0074_RegionID = C.T0074_RegionID   " +
      "left join t0070_countrycatalog CC on CC.T0070_CountryID = C.T0070_CountryID  " +
      "left join t0073_indsubind I on I.T0073_IndSubIndID = C.T0073_IndustryID  " +
      "left join t0073_indsubind SI on SI.T0073_IndSubIndID = C.T0073_SubIndID  " +
      "left join t0071_currencycatalog Cur on Cur.T0071_CurrencyID = C.T0071_CurrencyID  " +
